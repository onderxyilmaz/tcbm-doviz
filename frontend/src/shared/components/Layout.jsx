        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            <div className="flex">
              ...
              <div className="sm:ml-6 flex space-x-4 sm:space-x-8">
                <Link
                  to="/"
                  className={`inline-flex items-center px-2 sm:px-1 pt-1 border-b-2 text-sm font-medium transition-colors ${
                    location.pathname === '/'
                ...
                >
                  ...
                  <span className="hidden sm:inline">Güncel Kurlar</span>
                </Link>
                <Link
                  to="/settings"
                  className={`inline-flex items-center px-2 sm:px-1 pt-1 border-b-2 text-sm font-medium transition-colors ${
